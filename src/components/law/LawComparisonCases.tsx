...
function LawCases({ onOpenModal }: LawComparisonCasesProps) {
  const cases = [
    { icon: "FileSearch", title: "Возражения по акту ФНС", time: "24 часа", desc: "Доначисления на 150 млн ₽. После анализа акта и подготовки возражений снижены до 43 млн ₽." },
    { icon: "Landmark", title: "Иск по налоговому спору", time: "24 часа", desc: "Компания получила отказ УФНС и решила обжаловать в арбитраже. Процессуальный срок — через 26 часов. Подготовили полноценный иск с правовым обоснованием и расчётом требований. Подан в срок. Дело принято к производству." },
    { icon: "FileText", title: "Срочный отзыв на иск", time: "< 24 часов", desc: "Контрагент подал иск на 4,3 млн ₽. Документы получены вечером, заседание — через 5 дней, юрист клиента недоступен. Отзыв готов к следующему утру. Суд принял позицию. Иск удовлетворён частично — снижение требований на 2,1 млн ₽." },
    { icon: "ShieldAlert", title: "Уголовный риск для собственника", time: "анализ дела", desc: "ФНС передала материалы в СКР. Собственник вызван на допрос через 3 дня. За 24 часа провели анализ документов и позиции следствия. Выявлены нарушения при сборе доказательной базы. Скорректировали линию защиты до допроса. Уголовное дело прекращено на стадии доследственной проверки." },
  ];
