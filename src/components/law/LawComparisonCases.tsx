...
function LawCases({ onOpenModal }: LawComparisonCasesProps) {
  const cases = [
    ...
    { icon: "Landmark", title: "Иск по налоговому спору", time: "24 часа", desc: "Подготовили полноценный иск с правовой позицией за сутки до истечения процессуального срока." },
    { icon: "FileText", title: "Срочный отзыв на иск", time: "< 24 часов", desc: "Документ передан раньше дедлайна. Позиция принята судом без замечаний." },
    { icon: "ShieldAlert", title: "Уголовный риск", time: "анализ дела", desc: "Выявлены процессуальные нарушения на стадии следствия. Позиция защиты скорректирована до суда." },
  ];
